...
public class WindowAggregateAndProcess {
    public static void main(String[] args) throws Exception {
        ...
        // 1. 窗口分配器
        WindowedStream<WaterSensor, String, org.apache.flink.streaming.api.windowing.windows.TimeWindow> sensorWS = sensorKS.window(TumblingProcessingTimeWindows.of(Time.seconds(10)));
