...
public class stockSerializable implements Serializable {
    ...
    public stockSerializable() {
    }

    public stockSerializable(String date, String symbol, String adjClose, String close, String high, String low, String open, String volume) {
        this.date = date;
        this.symbol = symbol;
